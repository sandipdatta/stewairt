...
root_agent = Agent(
   ...
   model="gemini-2.0-flash-live-preview-04-09", # Using the flash model for low-latency streaming as required.
   # model="gemini-2.0-flash-live-001", # Fallback model as per ADK docs.
